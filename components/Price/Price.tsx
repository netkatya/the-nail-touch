  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 max-w-5xl relative z-10">
        ...
        <div className="bg-linear-to-b from-white to-(--color-bg-soft) py-4 px-4">
          <div className="max-w-3xl mx-auto">
            <div className="space-y-4">
              {pricingGroups.map((group, index) => (
                <div
                  key={index}
                  className="bg-(--color-bg-soft) rounded-lg shadow-md overflow-hidden border border-slate-200 transition-all duration-300 hover:shadow-lg"
                >
                  <button
